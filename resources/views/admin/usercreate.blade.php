        ...
        <div class="traffic-analysis-area">
            ...
            <div class="header-panel-body">
                ...
                <div class="sparkline13-list">
                    <form action="{{url('textla/user/create')}}" method="post" id="user_form"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Full Name" title="Please enter Full Name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="email">Email <span
                                            class="text-danger">*</span></label>
                                    <input type="text" placeholder="Email" title="Please enter you Email" name="email"
