        ...
        <div class="traffic-analysis-area">
            ...
            <div class="header-panel-body">
                ...
                <div class="sparkline13-list">
                    <form action="{{url('textla/role/create')}}" method="post" id="role_form"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Role Name" name="rolename" id="rolename"
                                        class="form-control form-control-sm">

                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="roledescription">Description</label>
                                    <textarea placeholder="Description" name="roledescription" id="roledescription"
                                        cols="30" rows="10" class="form-control form-control-sm"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-md" type="submit">Create Role</button>
