                                    ...
                                    <div class="sparkline13-graph">                                
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                            <table class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th width="30%" class="sorting" data-sorting_type="asc" data-column_name="fullname" style="cursor: pointer">Customer Name <span id="fullname_icon"></span></th>
                                                        ...
                                                        <th width="20%" class="sorting" data-sorting_type="asc" data-column_name="mobile" style="cursor: pointer">Mobile <span id="mobile_icon"></span></th>
                                                        <th width="10%">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @include('admin.part.customer_pagination')
                                                </tbody>
                                            </table>
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                ...
                                                function fetch_data(page, sort_type, sort_by, query) {
                                                    $.ajax({
                                                        url: "/admin/customer?page=" + page + "&sortby=" + sort_by + "&sorttype=" + sort_type + "&query=" + query,
                                                ...
                                                function view_profile(id) {                                                    
                                                    $.ajax({
                                                        url: "<?php echo asset('/').'textla/customer/profile?id='?>" + id,
                                                        success: function(data) {                                                           
