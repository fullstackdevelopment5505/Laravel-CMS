                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="sparkline13-list">
                                ...
                                <div class="sparkline13-graph">  
                                    ...
                                    @endif                              
                                    <form  action="{{url('textla/category/post-update')}}" method="post" id="category_form" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Category Name"  value="{{$category->category_name}}" name="category_name" id="category_name" class="form-control form-control-sm">
                                            ...
                                            <div class="col-md-2">
                                                 <a onClick="openModel()">
                                                <img id="output" src="<?php echo asset('/').'public'?>/{{$category->media_url}}" class="img-preview img-thumbnail img-fluid"/>
                                                <input type="text" style="opacity: 0;position: absolute;bottom: 25px;" placeholder="Category Name" value="{{$category->media_id}}" name="media_id" id="media_id" class="form-control form-control-sm">
</a>
                                            </div>
                                            ...
                                            <script>
                                                window.setTimeout(function() {
                                                    ...
                                                    $(".alert-success").fadeTo(500, 0).slideUp(500, function(){
                                                        window.location.href=window.location.origin+"/textla/category";
                                                    });
                                                }, 3000);
