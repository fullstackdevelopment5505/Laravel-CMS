                                ...
                                <div class="sparkline13-graph"> 
                                    ...
                                    <form name="productForm" ng-submit="submitForm(productForm.$valid)" novalidate method="post" id="product_form" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="tab-content product-content">
                                                    <div id="categories" class="tab-pane fade in active">
                                                        <select multiple="multiple" size="10" name="product_categories"  required ng-model="product.product_categories">
                                                    ...
                                                    <div id="images" class="tab-pane fade">
                                                     ...
                                                     <div id="relatedproducts" class="tab-pane fade">
                                                         <select multiple="multiple" size="10" name="related_products" ng-model="product.related_products">
                                            ...
                                            <script src="<?php echo asset('/').'public/';?>ctrl/product.js"></script>
                                            <script>
                                                ...
                                                $('select[name="product_categories"]').bootstrapDualListbox();
                                                $('select[name="related_products"]').bootstrapDualListbox();
