                                ...
                                <div class="sparkline13-hd">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 m-b-15 text-right">
                                            <a href="<?php echo asset('/').'cms_admin/category/create'?>" class="btn btn-primary btn-sm">Create</a>
                                        </div>
                                    </div>
                                ...
                                <div class="sparkline13-graph">     
                                   ...
                                   <table class="tree table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($categories as $category)
                                                <tr class="treegrid-{{$category->id}}">
                                                    ...
                                                    <td><img src="<?php echo asset('/').'public'?>/{{$category->category_url}}" class="category-image img-responsive img-fluid" ></td>
                                                    <td>
                                                        <a href="<?php echo asset('/').'cms_admin/category/update?id='?>{{ $category->id }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                    ...
                                    <script>
                                        ...
                                        {
                                            var id = id;
                                            var urlstr = "{{url('cms_admin/category/delete?id=')}}";
                                            urlstr = urlstr+id;
