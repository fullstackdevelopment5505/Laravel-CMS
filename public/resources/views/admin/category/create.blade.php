                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="sparkline13-list">
                                ...
                                <div class="sparkline13-graph">  
                                    ...
                                    @endif                              
                                    <form  action="{{url('cms_admin/category/post-create')}}" method="post" id="category_form" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Category Name" title="Please enter you category name" value="" name="category_name" id="category_name" class="form-control form-control-sm">
