            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li class="{{ Request::is('cms_admin/generalsetting') ? 'active' : '' }}">
                        ...
                        <li class="{{ Request::is('cms_admin/media') ? 'active' : '' }}">
                            <a href="<?php echo asset('/').'cms_admin/media'?>" aria-expanded="false">
                             <i class="fa fa-file"></i>&nbsp;<span class="mini-click-non">Media</span></a>
                        </li>
                </ul>
            </nav>
        </div>
